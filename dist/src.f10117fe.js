...
function () {
  ...
  CollectionView.prototype.render = function () {
    ...
    var tempelateElement = document.createElement("template");
...
function () {
  ...
  View.prototype.render = function () {
    this.parent.innerHTML = "";
    var tempelateElement = document.createElement("template");
    tempelateElement.innerHTML = this.template();
    this.bindEvents(tempelateElement.content);
    this.mapRegions(tempelateElement.content);
    this.onRender();
    this.parent.append(tempelateElement.content);
  };
...
var collection_1 = require("./models/collection"); // const user = User.buildUser({ name: "Hahaha", age: 244000 });
// // // user.fetch();
